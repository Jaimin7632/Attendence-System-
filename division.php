...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="division.php">DIVISION</a></li>
...
<center>
<form action="division.php" method="post" style="width: 300px;">

<select name='cname' class="form-control" required><?php
...
<?php if(isset($_POST['submit1'])){ ?>
<center>
<form action="pstore.php" method="post" ng-controller="ExampleController" >
<?php  $s=$_POST['cname'];  ?>
...
<h2>DIVISION</h2>
<input type="text" name="parta" placeholder="division_name" class="form-control" style="width: 300px;" ng-model="model" id="input"  my-directive required>
* if division exists then it auto update <br><br>
<!--student display-->
<?php $a = 0; ?>
<div class="container">
...
<input type="submit" name="submit222" value="submit" class="btn btn-primary">
 </form>
</center>
 <?php } ?>
